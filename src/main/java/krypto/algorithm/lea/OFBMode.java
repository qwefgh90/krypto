...
public class OFBMode extends LeaAlgorithm {

    // 객체 생성
    BlockCipherMode cipher = new LEA.OFB();
    byte[] initialVector;
    public OFBMode(String masterKey, int fixedKeySize, byte[] initialVector) {
        super(masterKey, fixedKeySize, Mode.OFB);
