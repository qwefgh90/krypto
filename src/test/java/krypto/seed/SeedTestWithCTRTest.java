...
public class SeedTestWithCTRTest {
    @Test
    void plainTextLessThan16() throws InvalidKeyException, WrongCounterLengthException {
        Algorithm algo = SeedAlgorithmFactory.createWithCTR("masterkey", "1234567812345678".getBytes());
    ...
    @Test
    void shortPlainText() throws InvalidKeyException, WrongCounterLengthException {
        Algorithm algo = SeedAlgorithmFactory.createWithCTR("masterkey", "1234567812345678".getBytes());
        String plain = "Hello";
        byte[] cipherText = algo.encrypt(plain.getBytes());
        byte[] decryptedText = algo.decrypt(cipherText);
    ...
    @Test
    void longPlainText() throws InvalidKeyException, WrongCounterLengthException {
        Algorithm algo = SeedAlgorithmFactory.createWithCTR("masterkey", "1234567812345678".getBytes());
